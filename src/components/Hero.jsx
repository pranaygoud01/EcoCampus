...
const Hero = () => {
  return (
    <div
      className="w-full h-[90vh] max-lg:h-[100vh] bg-cover bg-no-repeat bg-center"
      style={{
        backgroundImage:
    ...
    >
      <div className="w-full h-full bg-black/40 flex flex-col gap-2 max-lg:text-center max-lg:px-5 justify-center items-center">
        <h1 className="font-bold text-5xl max-lg:text-2xl text-white poppins">
        ...
        <div className="flex gap-2 items-center mt-5">
            <button className="font-semibold text-blue-500 bg-white rounded-lg px-5 py-2 text-sm">Register</button>
         <button className="font-semibold text-white  bg-white/20 rounded-lg px-4 py-2 text-sm ">Browse Items</button>
